...
<t:mainLayout title="Password retrieval">
  ...
  <h5>Please enter new password for your account..</h5><hr>
      <form:form class="form-horizontal" method="POST" autocomplete="false" commandName="user" action="/user/savePassword">
